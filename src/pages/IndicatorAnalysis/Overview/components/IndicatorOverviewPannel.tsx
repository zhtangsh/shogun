...
import GroupLineChartContainer from './GroupLineChartContainer';
const { RangePicker } = DatePicker;

type IndicatorOverviewPannelProp = {
  tagGroup: number;
};
const IndicatorOverviewPannel: React.FC<IndicatorOverviewPannelProp> = (props) => {
  ...
  const getIndicatorConfig = async () => {
    const result = await indicatorConfigListUsingGet({ tabGroup: props.tagGroup });
    const dataList = [];
...
export default IndicatorOverviewPannel;
